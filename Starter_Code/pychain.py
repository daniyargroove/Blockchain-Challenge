...
sender = st.text_input(label='Enter Sender Address', value='', max_chars=42, help='Ethereum address of the sender')

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver = st.text_input(label='Enter Receiver Address', value='', max_chars=42, help='Ethereum address of the receiver')

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount = st.number_input(label='Enter Amount', value=0, min_value=0, step=1, format="%d")
